...
SVCFusionStudioAudioProcessorEditor::SVCFusionStudioAudioProcessorEditor(
    SVCFusionStudioAudioProcessor &p)
...
void SVCFusionStudioAudioProcessorEditor::setupARAMode() {
#if JucePlugin_Enable_ARA
...
void SVCFusionStudioAudioProcessorEditor::setupNonARAMode() {
...
void SVCFusionStudioAudioProcessorEditor::setupCallbacks() {
...
void SVCFusionStudioAudioProcessorEditor::paint(juce::Graphics &) {
  // MainComponent handles all painting
}

void SVCFusionStudioAudioProcessorEditor::resized() {
  mainView->getComponent()->setBounds(getLocalBounds());
}

void SVCFusionStudioAudioProcessorEditor::visibilityChanged() {
  if (isVisible())
    mainView->getComponent()->grabKeyboardFocus();
}

void SVCFusionStudioAudioProcessorEditor::mouseDown(const juce::MouseEvent& e) {
  juce::ignoreUnused(e);
  mainView->getComponent()->grabKeyboardFocus();
}

...
class IMainView;
class SVCFusionStudioDocumentController;

/**
 * ARA Playback Renderer
 * Reads audio from ARA sources and applies pitch correction
 */
class SVCFusionStudioPlaybackRenderer : public juce::ARAPlaybackRenderer {
public:
...
private:
  ...
  SVCFusionStudioDocumentController *getDocController() const;
...
public:
  ...
  ~SVCFusionStudioDocumentController() override;

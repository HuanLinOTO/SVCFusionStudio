...
//==============================================================================
// SVCFusionStudioPlaybackRenderer
//==============================================================================

SVCFusionStudioDocumentController *
SVCFusionStudioPlaybackRenderer::getDocController() const {
  auto *docController = getDocumentController();
  return juce::ARADocumentControllerSpecialisation::
      getSpecialisedDocumentController<SVCFusionStudioDocumentController>(
          docController);
}

void SVCFusionStudioPlaybackRenderer::prepareToPlay(
...
void SVCFusionStudioPlaybackRenderer::releaseResources() {
  readers.clear();
  tempBuffer.reset();
}

bool SVCFusionStudioPlaybackRenderer::readFromARARegions(
...
bool SVCFusionStudioPlaybackRenderer::processBlock(
...
SVCFusionStudioDocumentController::~SVCFusionStudioDocumentController() {
  stopAnalysisThread();
...
void SVCFusionStudioDocumentController::stopAnalysisThread() {
  if (analysisState)
...
void SVCFusionStudioDocumentController::processAudioSource(
...
void SVCFusionStudioDocumentController::didAddAudioSourceToDocument(
    juce::ARADocument *, juce::ARAAudioSource *audioSource) {
  currentAudioSource = audioSource;
  processAudioSource(audioSource);
}

void SVCFusionStudioDocumentController::reanalyze() {
  if (currentAudioSource)
    processAudioSource(currentAudioSource);
}

juce::ARAPlaybackRenderer *
SVCFusionStudioDocumentController::doCreatePlaybackRenderer() noexcept {
  return new SVCFusionStudioPlaybackRenderer(
      ARADocumentControllerSpecialisation::getDocumentController());
}

bool SVCFusionStudioDocumentController::doRestoreObjectsFromStream(
...
bool SVCFusionStudioDocumentController::doStoreObjectsToStream(
